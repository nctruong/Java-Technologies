			...
			<div class="panel-heading">Dashboard</div>
				<div class="panel-body">
					<div class="modal-body">
						...
						<br>
						<br>
						<a class="btn btn-default" href="delete?studentId=${studentId}&scoreId=${scoreId}">OK</a>
						<a class="btn btn-default" href="<c:url value='/student/info?student_id=${studentId}'/>">Cancel</a>
					</div>				
					<br>				
