...
<link rel="stylesheet" type="text/css"
	href='<c:url value="/resources/css/editScore.css"/>' />
<script type="text/javascript"
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown "><a href="#" class="dropdown-toggle"
						...
						<ul class="dropdown-menu" role="menu">
							...
							<li class="divider"></li>
							<li><a
								href="${request.contextPath}/logout?userId=${student.id}">Logout</a></li>
						</ul>
				</ul>
			</div>
			<!-- /.navbar-collapse -->
		...
		<div class="col-md-10 content">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<table id="editScore">
						<tr>
							<th colspan="2">Edit Subject & Score</th>
						</tr>
						<form:form action="edit" method="POST" modelAttribute="scoreForm">
							<tr>
								<td class="left">Subject:</td>
								<td><form:input type="text" path="subject" class="form-control"/>
								</td>
							</tr>
							<tr>
								<td class="left">Score:</td>
								<td><form:input type="number" path="score" class="form-control"/>
								</td>
							</tr>
							<form:input path="student_id" type="hidden"
								value="${studentId}" />
							...
							<tr><td class="left"></td>
								<td>
									<input type="submit" class="btn btn-default"
										data-dismiss="submit" value="Submit" />
									<a href="<%=contextPath %>/student/info?student_id=${studentId}" class="btn btn-default" data-dismiss="modal">Cancel</a>
